...
<article
    ...
    <div class="py-6 px-5 h-full flex flex-col">
        <div>
            <img style="max-height: 400px;max-width: 350px" src="{{ asset('storage/' . $post->thumbnail) }}" alt="Blog Post illustration" class="rounded-xl">
        </div>
        ...
        <div class="mt-6 flex flex-col justify-between flex-1">
            <header>
                ...
                <div class="mt-4">
                    ...
                    <span class="mt-2 block text-gray-400 text-xs">
                        Publicado el <time>{{ $post->created_at->diffForHumans() }}</time>
                    </span>
                </div>
            </header>
            ...
            <footer class="flex justify-between bg-transparent items-center mt-8">
                <div class="flex items-center text-sm">
                    <img class="h-12 rounded-xl" src="/images/nokonsumo.jpg" alt="Nokonsumo avatar">
                    <div class="ml-3">
                        <h5 class="font-bold">
